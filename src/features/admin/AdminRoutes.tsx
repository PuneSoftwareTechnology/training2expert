...
const EnrollmentFiguresPage = lazy(() => import('./pages/EnrollmentFiguresPage'));
const PlacementReportsPage = lazy(() => import('./pages/PlacementReportsPage'));
const QrCodePage = lazy(() => import('./pages/QrCodePage'));
const RecruiterShortlistPage = lazy(() => import('./pages/RecruiterShortlistPage'));
    ...
    <AdminLayout>
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route path="reports/enrollment-figures" element={<EnrollmentFiguresPage />} />
          <Route path="reports/placement" element={<PlacementReportsPage />} />
          <Route path="qr-code" element={<QrCodePage />} />
          <Route path="recruiter-shortlist" element={<RecruiterShortlistPage />} />
